...
ActiveRecord::Schema.define(version: 20150916091715) do
  ...
  create_table "spr_pages", force: true do |t|
    t.string   "spr"
    t.string   "name"
    t.string   "image"
    t.text     "attrs"
  ...
  create_table "statistics_post_counts", force: true do |t|
    t.date    "date"
    t.integer "count"
  end

  add_index "statistics_post_counts", ["date"], name: "index_statistics_post_counts_on_date", using: :btree
