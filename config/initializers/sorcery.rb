...
Rails.application.config.sorcery.submodules = [:user_activation, :remember_me, :reset_password, :activity_logging, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  #
  config.external_providers = [:twitter, :facebook, :google, :vk, :liveid]
  ...
  #
  config.liveid.key = "000000004811E13E"
  config.liveid.secret = "DIyANrS0Brg6wxebO0JTD7CtRyiEZ2Lu"
  config.liveid.callback_url = "http://lvh.me:3000/oauth/callback?provider=liveid"
